...
const catalog_delijn_vlaenderen_1 = __importDefault(require("../catalog.delijn.vlaenderen"));
...
// Bind catalog
const combined = Catalog_1.default.combine(catalog_nmbs_1.default, catalog_delijn_vlaenderen_1.default);
container.bind(types_1.default.Catalog).toConstantValue(combined);
// Init LDFetch
...
//# sourceMappingURL=triangle_demo.js.map