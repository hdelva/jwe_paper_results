 ...
 */
export default class CSAProfile2 implements IPublicTransportPlanner {
    ...
    private initialReachableStops;
    private profilesByStop;
    private earliestArrivalByTrip;
    private durationToTargetByStop;
    private gtfsTripByConnection;
    private connectionsIterator;
    private readonly journeyExtractor;
    constructor(connectionsProvider: IConnectionsProvider, locationResolver: ILocationResolver, initialReachableStopsFinder: IReachableStopsFinder, transferReachableStopsFinder: IReachableStopsFinder, finalReachableStopsFinder: IReachableStopsFinder, eventBus?: EventEmitter);
