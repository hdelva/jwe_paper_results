...
const QueryRunnerEarliestArrivalFirst_1 = __importDefault(require("./QueryRunnerEarliestArrivalFirst"));
describe("[QueryRunnerExponential]", () => {
    ...
    const query = {
        ...
        maximumTransferDuration: Units_1.default.fromHours(30),
    };
    const createEarliestArrivalQueryRunner = () => {
        ...
        return new QueryRunnerEarliestArrivalFirst_1.default(context, connectionFetcher, locationResolver, createPlanner, reachableStopsFinder, reachableStopsFinder, reachableStopsFinder, undefined);
    };
    const result = [];
...
//# sourceMappingURL=QueryRunnerEarliestArrivalFirst.test.js.map